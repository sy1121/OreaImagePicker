...
public class PreviewActivity extends BaseActivity implements View.OnClickListener, OnCheckChangeListener {
    ...
    private void initView(){
        ...
        mViewPager = findViewById(R.id.preview_pic_big);
        mRecyclerView = findViewById(R.id.preview_pic_small);
        mEditBtn = findViewById(R.id.edit_btn);
        mChooseCheck = findViewById(R.id.choose_check);
        mHorizontalPanel = findViewById(R.id.preview_up_panel);
        mHeader = findViewById(R.id.preview_header);
        mFooter = findViewById(R.id.preview_footer);
